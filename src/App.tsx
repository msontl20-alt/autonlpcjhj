...
Trung thực,Tốt,"Em biết đấu tranh với những hành vi thiếu trung thực xung quanh mình."
...
Trung thực,Đạt,"Em biết đồng tình với những hành vi trung thực trong cuộc sống."
...
Tự chủ và tự học,Tốt,"Em biết tự lập lộ trình học tập và hoàn thành kế hoạch cá nhân một cách sáng tạo."
Tự chủ và tự học,Tốt,"Em chủ động tìm kiếm sự hỗ trợ khi cần thiết để giải quyết vấn đề cá nhân."
...
Tự chủ và tự học,Đạt,"Em hoàn thành các nhiệm vụ học tập với sự giúp đỡ từ thầy cô và bạn bè."
Tự chủ và tự học,Cần cố gắng,"Em chưa có ý thức tự học, cần nhắc nhở nhiều."
Tự chủ và tự học,Cần cố gắng,"Em còn phụ thuộc vào người khác, chưa tự giác hoàn thành bài làm."
...
Giao tiếp và hợp tác,Tốt,"Em luôn chủ động lắng nghe và phối hợp ăn ý với các thành viên trong nhóm."
Giao tiếp và hợp tác,Tốt,"Em có phong thái tự tin khi giao tiếp và biết cách thuyết phục người nghe."
Giao tiếp và hợp tác,Đạt,"Em biết cách giao tiếp cơ bản và hợp tác với nhóm."
Giao tiếp và hợp tác,Đạt,"Em biết lắng nghe và chia sẻ ý kiến với các bạn trong hoạt động tập thể."
Giao tiếp và hợp tác,Đạt,"Em hòa nhã, cởi mở khi trò chuyện cùng thầy cô và bạn bè."
Giao tiếp và hợp tác,Cần cố gắng,"Em chưa mạnh dạn trong giao tiếp và hợp tác."
Giao tiếp và hợp tác,Cần cố gắng,"Em còn thụ động, ít phát biểu ý kiến cá nhân trong quá trình làm việc nhóm."
...
Giải quyết vấn đề,Tốt,"Em luôn linh hoạt trong tư duy và tìm ra nhiều giải pháp hiệu quả cho bài tập khó."
Giải quyết vấn đề,Tốt,"Em có khả năng tự nhận xét và đánh giá mức độ hoàn thành nhiệm vụ của bản thân."
...
Ngôn ngữ,Tốt,"Kỹ năng đọc hiểu rất tốt, biết diễn đạt ý tưởng qua bài viết một cách sâu sắc và mạch lạc."
Ngôn ngữ,Tốt,"Em biết sử dụng linh hoạt các kiểu câu và từ ngữ để viết đoạn văn cảm xúc."
Ngôn ngữ,Đạt,"Đọc bài khá lưu loát, chữ viết tương đối rõ ràng, sạch sẽ."
Ngôn ngữ,Đạt,"Hiểu nội dung bài đọc và trả lời tốt các câu hỏi của bài học."
Ngôn ngữ,Đạt,"Em viết được câu có đủ thành phần và diễn đạt được ý của mình."
Ngôn ngữ,Đạt,"Em có tốc độ đọc đạt yêu cầu, viết đúng chính tả với tốc độ phù hợp."
...
Ngôn ngữ,Cần cố gắng,"Chữ viết chưa đúng mẫu, cần rèn luyện thêm về nét chữ và trình bày."
Tính toán,Tốt,"Nắm vững kiến thức đã học. Tính toán thành thạo, giải toán đúng và nhanh."
Tính toán,Tốt,"Thông minh, có trí nhớ tốt, tính toán nhanh nhẹn và chính xác."
Tính toán,Tốt,"Có tư duy toán tốt, giải toán có lời văn rất sáng tạo và trình bày khoa học."
Tính toán,Tốt,"Phát hiện nhanh các quy luật toán học và áp dụng hiệu quả vào thực hành."
Tính toán,Tốt,"Em nắm chắc kiến thức về hình học và biết vận dụng linh hoạt vào thực tiễn."
...
Tính toán,Đạt,"Em biết cách xem ngày giờ, tháng và thực hiện tốt các bài tập đo lường."
...
Khoa học,Tốt,"Chủ động nắm bắt và ghi nhớ kiến thức tốt, ham học hỏi tìm tòi khám phá."
Khoa học,Tốt,"Có vốn hiểu biết phong phú về tự nhiên, xã hội và bảo vệ môi trường."
Khoa học,Tốt,"Sáng tạo trong việc thực hiện các dự án nhỏ về khoa học và tìm hiểu thế giới."
Khoa học,Đạt,"Hoàn thành tốt nội dung và yêu cầu kiến thức môn học."
Khoa học,Đạt,"Nắm được kiến thức cơ bản và biết vận dụng bài học vào bảo vệ sức khỏe bản thân."
...
Thẩm mĩ,Tốt,"Có khiếu thẩm mĩ, thực hành khéo tay, sản phẩm sáng tạo và đẹp mắt."
Thẩm mĩ,Tốt,"Hát hay, biểu diễn tự nhiên, tự tin thể hiện cảm xúc qua bài hát."
Thẩm mĩ,Tốt,"Em vẽ tranh có bố cục hài hòa, màu sắc sinh động và giàu ý tưởng."
Thẩm mĩ,Tốt,"Hát đúng nhịp, giai điệu và biết kết hợp vận động phụ họa nhịp nhàng."
Thẩm mĩ,Đạt,"Hoàn thành tốt các sản phẩm mĩ thuật theo yêu cầu."
Thẩm mĩ,Đạt,"Thuộc lời bài hát, hát đúng lời ca và rõ tiếng."
Thẩm mĩ,Đạt,"Biết sử dụng màu sắc phù hợp để trang trí sản phẩm của mình."
Thẩm mĩ,Cần cố gắng,"Cần nhanh nhẹn và cẩn thận hơn trong các thao tác mĩ thuật."
Thẩm mĩ,Cần cố gắng,"Hát còn nhỏ, chưa tự tin khi tham gia biểu diễn trước lớp."
Thể chất,Tốt,"Hoàn thành tốt lượng vận động, tham gia tích cực và sôi nổi các trò chơi."
...
Thể chất,Tốt,"Nhanh nhẹn, có tinh thần cầu tiến và tích cực giúp đỡ bạn cùng tập luyện."
Thể chất,Đạt,"Em thực hiện được các động tác thể dục cơ bản theo yêu cầu."
Thể chất,Đạt,"Có ý thức rèn luyện và tham gia các trò chơi vận động cùng nhóm."
Thể chất,Đạt,"Hoàn thành các bài tập tư thế và kỹ năng vận động cơ bản."
...
Công nghệ,Tốt,"Em có hiểu biết tốt về thế giới công nghệ và biết vận dụng thực hành hiệu quả."
Công nghệ,Tốt,"Lắp ráp mô hình kĩ thuật sáng tạo, chắc chắn và trình bày đẹp."
Công nghệ,Tốt,"Sử dụng các dụng cụ an toàn, thành thạo và bảo quản thiết bị rất tốt."
Công nghệ,Đạt,"Em có kiến thức nền tảng về môn học và hoàn thành các bài thực hành."
...
Tin học,Tốt,"Em thao tác tốt với chuột và bàn phím, thực hiện nhanh và chính xác."
Tin học,Tốt,"Sử dụng linh hoạt các phần mềm học tập và có ý thức an toàn mạng."
Tin học,Tốt,"Em biết phân biệt giữa nháy chuột và nháy đúp chuột khi thao tác trên máy."
Tin học,Tốt,"Em gõ bàn phím 10 ngón đúng quy tắc và nhập văn bản nhanh, chính xác."
Tin học,Tốt,"Có khả năng khai thác phần mềm để ứng dụng vào các môn học khác hiệu quả."
Tin học,Đạt,"Em biết cách khởi động và thoát khỏi phần mềm đúng quy trình."
Tin học,Đạt,"Hoàn thành tốt các bài thi và thực hành trên máy ở mức yêu cầu."
Tin học,Đạt,"Biết cách sử dụng máy tính an toàn và giữ gìn thiết bị của lớp."
Tin học,Cần cố gắng,"Em cần thực hành nâng cao kỹ năng sử dụng chuột và bàn phím."
        ...
        Object.keys(criteriaMapping).forEach(mainCriteria => {
          ...
          if (keywords.some(kw => colStr.includes(kw))) {
            ...
            if (foundCriteriaCols[mainCriteria] === undefined) {
              ...
              // AUTO-DETECT GRADE BLOCK: If 'Công nghệ' or 'Tin học' are found, it's likely k345
              if (mainCriteria === 'Công nghệ' || mainCriteria === 'Tin học') {
                setGradeBlock('k345');
              }
            }
          }
